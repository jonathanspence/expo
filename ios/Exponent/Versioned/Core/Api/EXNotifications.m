...
{
  [[EXUserNotificationCenter sharedInstance] removePendingNotificationRequestsWithIdentifiers:@[[self getScopedIdIfDetached:uniqueId]]];
}
                 ...
                 rejecter:(__unused RCTPromiseRejectBlock)reject)
{
  ...
  UNNotificationCategory *newCategory = [UNNotificationCategory categoryWithIdentifier:[self getScopedIdIfDetached:categoryId]
